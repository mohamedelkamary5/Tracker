...
const NoConnection = () => {
    return (
        <div className='no-conneciont-component'>
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="549.76px" height="549.76px" viewBox="0 0 549.76 549.76" style={{ enableBackground: 'new 0 0 549.76 549.76' }} xmlSpace="preserve">
                <g>
