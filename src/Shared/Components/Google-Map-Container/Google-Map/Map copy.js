...
class GoogleMapComponetTracking extends Component {
	...
	// 				},
	// 			})
	// 			this.props.handleMapInfo({ address: address, lat: newLat, lng: newLng })
	// 		},
	// 		error => {
	// 			console.error(error);
	// 		}
...
export default GoogleMapComponetTracking
