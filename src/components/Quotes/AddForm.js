                ...
                <div className='col-lg-3'>
                  <div className="mb-3">
                    <Form.Item
                      ...
                      rules={[{ required: true, message: '' }]}
                    >
                      <Input type="number" className='form-control' name='sequence' value={values.sequence} placeholder="اكتب تسلسل" onChange={handelChange} />
                    </Form.Item>
                ...
                <div className='col-lg-3'>
                  <div className="mb-3">
                    <Form.Item
                      ...
                      rules={[{ required: true, message: '' }]}
                    >
                      <Input type="number" className='form-control' name='cost' value={values.cost} placeholder="اكتب التكلفة" onChange={handelChange} />
                    </Form.Item>
                    {handelError('cost')}
                  </div>
                </div>
                ...
                <div className='col-lg-3'>
                  <div className="mb-3">
                    <Form.Item
                      ...
                      rules={[{ required: true, message: '' }]}
                    >
                      <Input type="number" className='form-control' name='drivers_count' value={values.drivers_count} placeholder="اكتب عدد السائقين" onChange={handelChange} />
                    </Form.Item>
                ...
                <div className='col-lg-3'>
                  <div className="mb-3">
                    <Form.Item
                      ...
                      rules={[{ required: true, message: '' }]}
                    >
                      <Input type="number" className='form-control' name='months' value={values.months} placeholder="اكتب الاشهور" onChange={handelChange} />
                    </Form.Item>
                    {handelError('months')}
                  </div>
                </div>
