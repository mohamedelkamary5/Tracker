...
const HeaderButton = ({id, status }) => {
   ...
   const from = location.state?.from?.pathname || "/admin/managers";
  ...
  return (
    <MainHeaderClint>
        <MainButtonClint>
            ...
            <button onClick={handelDelete} ><AiOutlineDelete className='icon-button' />{t("btnDelManager")}</button>
        </MainButtonClint>
        <ButtonReturn title="/admin/managers" />
