...
import { getManagers, searchManagers, handleListView } from '../../store/ManagersSlice';
...
const TableAllUsers = ({ HandelShowCustomer }) => {
    ...
    useEffect(() => {
        const search = () => {
            ...
            if (inputValue) {
                dispatch(searchManagers(inputValue))
            } else {
                dispatch(getManagers(1))
            }
        }
        ...
        <div className="main-table">
            ...
            <div className='style-main-sort'>
                ...
                <form className='form-search'>
                    <input type="search" placeholder={t("searchManagers")}
